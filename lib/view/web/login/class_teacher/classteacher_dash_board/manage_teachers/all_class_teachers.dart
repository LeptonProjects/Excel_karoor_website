                ...
                Row(
                  children: [
                    ...
                    GoogleMonstserratWidgets(
                      text:
                          '${Get.find<GetFireBaseData>().bYear.value} -Manage Teacher', ////changed normal text to original batch year
                      //'2023 -2024 batch',
                      fontsize: 17.w,
                      color: cWhite,
                    )
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: TextButton.icon(
                                                onPressed: () async {
                                                  log('teachernameeee${snapshot.data?.docs[index]['teacherName'] ?? ""}');
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                GoogleMonstserratWidgets(
                  text:
                      '${Get.find<GetFireBaseData>().bYear.value} -Teacher List', ////changed normal text to original batch year
                  //'2023 -2024 batch',
                  fontsize: 17.w,
                  color: cBlack,
                  fontWeight: FontWeight.bold,
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        log('sdsdsd${snapshot.data!.docs[index]['teacherName']}');
                                        manageTeachersController
                                            .addteachersToClass(
                                                snapshot.data!.docs[index]
                                                    ['docid'],
